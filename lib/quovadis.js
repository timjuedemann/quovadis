...
var Quovadis = /*#__PURE__*/function () {
  ...
  _createClass(Quovadis, [{
    ...
    value: function getLastChild(el) {
      ...
      if (el.nodeName != "SCRIPT" && el.nodeName != "LINK" && css.getPropertyValue('position') != "absolute" && css.getPropertyValue('position') != "fixed" && css.getPropertyValue('position') != "sticky") {
